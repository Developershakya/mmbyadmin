  ...
  return (
    <header className="h-[72px] bg-white border-b border-slate-200/80 sticky top-0 z-30 px-4 md:px-8 flex items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-3">
        {/* Safety Guard Test Mode Badge */}
        <div
          id="admin-test-mode-badge"
          title="Safety Active: Razorpay Test Mode & Dummy Booking Supplier Enabled"
          className="hidden sm:inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-amber-50 border border-amber-300 text-amber-800 text-[11px] font-bold tracking-wide shadow-2xs cursor-help"
        >
